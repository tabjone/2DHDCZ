...
void read_and_interpolate_solar_s_data(double *r_over_R, double *c_s, double *rho, double *p, double *Gamma_1, double *T, double *H, double *superad_param, double *grad_s, double *g, double del_ad, int size)
{
    /*
    ...
    */
    ...
    allocate_1D_array(&g_solar_s, solar_s_size);
    ...
    {
        interpolate_solar_s(r_over_R_solar_s, c_s_solar_s, rho_solar_s, p_solar_s, Gamma_1_solar_s, T_solar_s, H_solar_s, superad_param_solar_s, grad_s_solar_s, g_solar_s, &r_over_R[i], &c_s[i], &rho[i], &p[i], &Gamma_1[i], &T[i], &H[i], &superad_param[i], &grad_s[i], &g[i], solar_s_size);
    }
