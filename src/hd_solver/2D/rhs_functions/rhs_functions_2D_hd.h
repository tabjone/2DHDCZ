...
double rhs_ds1_dt_2D_hd(struct BackgroundVariables *background_variables, struct ForegroundVariables *foreground_variables, int i, int j, double dx, double dz, int nx);
