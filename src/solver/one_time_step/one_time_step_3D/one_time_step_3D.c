...
{   
    ...
    */
    ...
    #if TIME_ORDER == 1
        dt = rk1_3D(bg, fg_prev, fg, grid_info, mpi_info, precalc, dt_last, first_timestep);
    #elif TIME_ORDER == 2
        dt = rk2_3D(bg, fg_prev, fg, grid_info, mpi_info, precalc, dt_last, first_timestep);
    #elif TIME_ORDER == 3
        dt = rk3_3D(bg, fg_prev, fg, grid_info, mpi_info, precalc, dt_last, first_timestep);
    #endif // TIME_ORDER
