...
{
    /*
    Communicates ghost cells above and below the current process for a 3D array using the odd-even method.
    ...
    */
    ...
    {
        communicate_3D_ghost_periodic_boundary(array, mpi_info, nz, nz_ghost, ny, nx);
    }
}